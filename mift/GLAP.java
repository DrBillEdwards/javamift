        ...
        final TimerTask line3TimerTask = new TimerTask()
        {
            ...
            public void run()
            {
                ...
                if(GLAPOptions.half_20_6_AndAHalfLine3)
                {
                    if ((t >= (Constants.SECS_PER_MIN * 30)) && (t < (Constants.SECS_PER_HOUR)))
                    {
                        System.out.println("FAILED LINE 3 (.5-1-6.5), t: " + t);
                        outputs[i++] = "FAILED LINE 3 (.5-1-6.5), t: " + t;
                        displayText[4] = "line3 ";
        ...
        final TimerTask line4TimerTask = new TimerTask()
        {
            ...
            public void run()
            {
                ...
                if(GLAPOptions.half_20_6_AndAHalfLine4)
                {
                    if ((t >= (Constants.SECS_PER_MIN * 30)) && (t < (Constants.SECS_PER_HOUR)))
                    {
                        System.out.println("FAILED LINE 4 (.5-1-6.5), t: " + t);
                        outputs[i++] = "FAILED LINE 4 (.5-1-6.5), t: " + t;
                        displayText[5] = "line4 ";
